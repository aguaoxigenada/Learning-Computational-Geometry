...
namespace jmk
{
	...
	// #define statements define constants that can be
	// used throughout the code. Here, DIM2, DIM3, X, Y, and Z are defined for convenience to represent dimensionality and coordinates.
	...
	public:
		...
		// Constructors for 3D and 2D vectors.
		...
		// Method to assign a value to a specific dimension.
	...
	// Definition of the scalar multiplication operator.
	...
	// Definition of the less-than operator.
	template<class coordinate_type, size_t dimensions>
	inline bool Vector<coordinate_type, dimensions>::operator<(const Vector<coordinate_type, dimensions>& _other) const
	{
		for (size_t i = 0; i < dimensions; i++)
	...
	// Method to assign a value to a specific index.
	template<class coordinate_type, size_t dimensions>
	...
	// Function prototypes for cross product and scalar triple product.
